...
CRO_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
...
<rect x="50" y="115" width="20" height="30" fill="#666"/>
<text x="60" y="105" text-anchor="middle" font-size="9">Electron Gun</text>
<rect x="130" y="105" width="20" height="5" fill="#000"/>
<rect x="130" y="150" width="20" height="5" fill="#000"/>
<text x="140" y="95" text-anchor="middle" font-size="9">Y-Plates</text>
<rect x="180" y="115" width="10" height="30" fill="#000"/>
<text x="185" y="165" text-anchor="middle" font-size="9">X-Plates</text>
<path d="M 70 130 L 360 130" stroke="lime" stroke-width="2" stroke-dasharray="4"/>
<rect x="360" y="90" width="10" height="80" fill="lime"/>
<text x="375" y="135" font-size="9">Screen</text>
</svg>"""

TRANSFORMER_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
...
GENERATOR_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
<text x="210" y="20" text-anchor="middle" font-size="14" font-weight="bold" fill="#004a99">AC GENERATOR</text>
<rect x="50" y="70" width="50" height="100" fill="red"/>
<text x="75" y="125" text-anchor="middle" fill="white" font-weight="bold">N</text>
<rect x="320" y="70" width="50" height="100" fill="blue"/>
...
<ellipse cx="170" cy="180" rx="10" ry="20" fill="none" stroke="#d4af37" stroke-width="3"/>
<ellipse cx="250" cy="180" rx="10" ry="20" fill="none" stroke="#d4af37" stroke-width="3"/>
...
<rect x="140" y="170" width="10" height="20" fill="#333"/>
<rect x="270" y="170" width="10" height="20" fill="#333"/>
...
CIRCUIT_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
...
<line x1="200" y1="60" x2="200" y2="100" stroke="#333" stroke-width="3"/>
<line x1="220" y1="70" x2="220" y2="90" stroke="#333" stroke-width="6"/>
...
<path d="M 180 200 L 185 190 L 195 210 L 205 190 L 215 210 L 225 190 L 235 210 L 240 200" fill="none" stroke="#333" stroke-width="2"/>
<text x="210" y="225" text-anchor="middle" font-size="10">Resistor (R)</text>
<circle cx="320" cy="140" r="15" fill="white" stroke="#333" stroke-width="2"/>
...
<circle cx="210" cy="160" r="15" fill="white" stroke="#333" stroke-width="2"/>
<text x="210" y="165" text-anchor="middle" font-size="12">V</text>
<text x="210" y="140" text-anchor="middle" font-size="10">Voltmeter</text>
</svg>"""

LEVER_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
...
<rect x="70" y="80" width="40" height="40" fill="#666" stroke="#333"/>
<text x="90" y="105" text-anchor="middle" font-size="10" fill="white">Load</text>
<line x1="330" y1="80" x2="330" y2="115" stroke="red" stroke-width="3"/>
...
WAVE_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
<text x="210" y="20" text-anchor="middle" font-size="14" font-weight="bold" fill="#004a99">TRANSVERSE WAVE</text>
<line x1="40" y1="130" x2="380" y2="130" stroke="#333" stroke-width="1" stroke-dasharray="4"/>
<path d="M 60 130 Q 100 50 140 130 T 220 130 T 300 130 T 380 130" fill="none" stroke="#004a99" stroke-width="3"/>
<line x1="100" y1="130" x2="100" y2="90" stroke="red" stroke-width="2"/>
<polygon points="100,90 97,95 103,95" fill="red"/>
<text x="110" y="115" font-size="12" fill="red">Amplitude (A)</text>
<line x1="100" y1="60" x2="260" y2="60" stroke="#000" stroke-width="1"/>
...
<line x1="330" y1="180" x2="380" y2="180" stroke="green" stroke-width="3"/>
...
PULLEY_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
<text x="210" y="20" text-anchor="middle" font-size="14" font-weight="bold" fill="#004a99">SINGLE FIXED PULLEY</text>
<rect x="150" y="40" width="120" height="10" fill="#333"/>
...
<line x1="210" y1="50" x2="210" y2="90" stroke="#333" stroke-width="4"/>
<circle cx="210" cy="110" r="30" fill="none" stroke="#666" stroke-width="5"/>
<circle cx="210" cy="110" r="5" fill="#333"/>
<line x1="180" y1="110" x2="180" y2="180" stroke="#000" stroke-width="2"/>
<line x1="240" y1="110" x2="240" y2="180" stroke="#000" stroke-width="2"/>
<rect x="165" y="180" width="30" height="30" fill="#8b4513"/>
...
<line x1="240" y1="180" x2="240" y2="220" stroke="red" stroke-width="2"/>
...
MOTOR_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
<rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/>
<text x="210" y="20" text-anchor="middle" font-size="14" font-weight="bold" fill="#004a99">DC MOTOR</text>
<rect x="50" y="80" width="50" height="80" fill="red"/>
<text x="75" y="125" text-anchor="middle" fill="white" font-weight="bold">N</text>
<rect x="320" y="80" width="50" height="80" fill="blue"/>
<text x="345" y="125" text-anchor="middle" fill="white" font-weight="bold">S</text>
...
<rect x="180" y="165" width="10" height="10" fill="#333"/>
<rect x="230" y="165" width="10" height="10" fill="#333"/>
...
LENS_SVG = """<svg width="100%" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg"><rect width="420" height="260" fill="#f0f8ff" stroke="#004a99" stroke-width="2" rx="8"/><text x="210" y="25" text-anchor="middle" font-size="14" font-weight="bold" fill="#004a99">CONVEX LENS - RAY DIAGRAM</text><path d="M 200 50 Q 220 120 200 190 Q 180 120 200 50" fill="lightblue" stroke="#333"/><line x1="210" y1="50" x2="210" y2="190" stroke="#999" stroke-dasharray="4"/><text x="210" y="210" text-anchor="middle" font-size="9">PRINCIPAL AXIS</text><line x1="80" y1="120" x2="340" y2="120" stroke="red" stroke-width="1.5"/><line x1="80" y1="120" x2="200" y2="70" stroke="blue" stroke-width="1.5"/><line x1="200" y1="70" x2="340" y2="120" stroke="blue" stroke-width="1.5"/><text x="70" y="115" font-size="9">OBJECT</text><text x="345" y="115" font-size="9">REAL IMAGE</text></svg>"""
