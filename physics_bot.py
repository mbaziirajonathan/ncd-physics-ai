...
# ========== UPDATED SVG DIAGRAM FUNCTIONS - UNEB STANDARD ==========
def svg_lever():
...
<polygon points="200,100 190,120 210,120" fill="gray"/><text x="200" y="140" text-anchor="middle">Fulcrum</text>
<line x1="100" y1="100" x2="100" y2="60" stroke="red" stroke-width="3"/><text x="100" y="50" text-anchor="middle" fill="red">Effort</text>
<line x1="300" y1="100" x2="300" y2="50" stroke="blue" stroke-width="3"/><text x="300" y="40" text-anchor="middle" fill="blue">Load</text>
<text x="200" y="25" text-anchor="middle" font-size="18" font-weight="bold">Class 1 Lever</text></svg>"""
...
<line x1="200" y1="155" x2="200" y2="120" stroke="black" stroke-width="2"/><text x="210" y="135">W</text>
<line x1="200" y1="155" x2="170" y2="155" stroke="black" stroke-width="2"/><text x="150" y="160">F</text>
<line x1="200" y1="155" x2="200" y2="185" stroke="black" stroke-width="2"/><text x="210" y="195">R</text>
<text x="200" y="30" text-anchor="middle" font-size="18" font-weight="bold">Inclined Plane - Forces</text></svg>"""

def svg_ohm():
    return """<svg width="100%" viewBox="0 0 400 200" style="background:white;border-radius:8px">
<text x="50" y="90" font-weight="bold">+</text>
<rect x="60" y="80" width="50" height="20" fill="#ffe066" stroke="black" stroke-width="2"/><text x="85" y="70" text-anchor="middle">Battery</text>
<line x1="110" y1="90" x2="140" y2="90" stroke="black" stroke-width="2"/>
<rect x="140" y="80" width="50" height="20" fill="white" stroke="black" stroke-width="2"/><text x="165" y="70" text-anchor="middle">Ammeter A</text>
<line x1="190" y1="90" x2="220" y2="90" stroke="black" stroke-width="2"/>
<rect x="220" y="80" width="50" height="20" fill="white" stroke="black" stroke-width="2"/><text x="245" y="70" text-anchor="middle">Resistor R</text>
<line x1="270" y1="90" x2="300" y2="90" stroke="black" stroke-width="2"/>
<rect x="300" y="80" width="50" height="20" fill="white" stroke="black" stroke-width="2"/><text x="325" y="70" text-anchor="middle">Voltmeter V</text>
<polyline points="350,90 350,130 50,130 50,100" fill="none" stroke="black" stroke-width="2"/>
<text x="50" y="150" font-weight="bold">-</text>
<text x="200" y="25" text-anchor="middle" font-size="18" font-weight="bold">Series Circuit: Ohm's Law V=IR</text></svg>"""

def svg_prism():
    return """<svg width="100%" viewBox="0 0 400 200" style="background:white;border-radius:8px">
<polygon points="100,150 300,150 250,50 150,50" fill="#add8e6" stroke="black" stroke-width="2"/>
<line x1="50" y1="100" x2="150" y2="80" stroke="white" stroke-width="3"/>
<line x1="150" y1="80" x2="250" y2="120" stroke="red" stroke-width="2"/>
<line x1="150" y1="80" x2="250" y2="100" stroke="orange" stroke-width="2"/>
<line x1="150" y1="80" x2="250" y2="90" stroke="yellow" stroke-width="2"/>
<line x1="150" y1="80" x2="250" y2="80" stroke="green" stroke-width="2"/>
<line x1="150" y1="80" x2="250" y2="70" stroke="blue" stroke-width="2"/>
<line x1="150" y1="80" x2="250" y2="60" stroke="indigo" stroke-width="2"/>
<line x1="150" y1="80" x2="250" y2="50" stroke="violet" stroke-width="2"/>
<text x="200" y="25" text-anchor="middle" font-size="18" font-weight="bold">Triangular Prism - Dispersion of White Light</text></svg>"""
...
<line x1="100" y1="130" x2="100" y2="70" stroke="red" stroke-width="3"/><text x="100" y="160" text-anchor="middle">Object</text>
<line x1="300" y1="80" x2="300" y2="120" stroke="blue" stroke-width="3"/><text x="300" y="60" text-anchor="middle">Real Image</text>
<text x="150" y="90" text-anchor="middle">F</text><text x="250" y="90" text-anchor="middle">F</text>
<line x1="100" y1="100" x2="200" y2="100" x2="300" y2="100" stroke="orange" stroke-width="1" stroke-dasharray="3,3"/>
<line x1="100" y1="70" x2="200" y2="100" x2="300" y2="120" stroke="green" stroke-width="1"/>
<text x="200" y="25" text-anchor="middle" font-size="18" font-weight="bold">Convex Lens - Real Image</text></svg>"""
...
<line x1="100" y1="130" x2="100" y2="70" stroke="red" stroke-width="3"/><text x="100" y="160" text-anchor="middle">Object</text>
<line x1="50" y1="80" x2="50" y2="120" stroke="blue" stroke-width="3" stroke-dasharray="5,5"/><text x="50" y="60" text-anchor="middle">Virtual Image</text>
<text x="150" y="90" text-anchor="middle">F</text><text x="250" y="90" text-anchor="middle">F</text>
<line x1="100" y1="70" x2="200" y2="100" stroke="green" stroke-width="1"/><line x1="200" y1="100" x2="250" y2="70" stroke="green" stroke-width="1" stroke-dasharray="3,3"/>
<line x1="100" y1="130" x2="200" y2="100" stroke="orange" stroke-width="1"/><line x1="200" y1="100" x2="250" y2="130" stroke="orange" stroke-width="1" stroke-dasharray="3,3"/>
<text x="200" y="25" text-anchor="middle" font-size="18" font-weight="bold">Concave Lens - Virtual Image</text></svg>"""

def svg_transformer():
    return """<svg width="100%" viewBox="0 0 400 200" style="background:white;border-radius:8px">
<rect x="120" y="50" width="40" height="100" fill="gray" stroke="black"/><text x="140" y="40" text-anchor="middle">Primary N1</text>
<rect x="240" y="50" width="40" height="100" fill="gray" stroke="black"/><text x="260" y="40" text-anchor="middle">Secondary N2</text>
...
<line x1="90" y1="90" x2="100" y2="90" stroke="red" stroke-width="2"/><text x="80" y="95">Vin</text>
<line x1="300" y1="90" x2="310" y2="90" stroke="blue" stroke-width="2"/><text x="315" y="95">Vout</text>
<text x="200" y="25" text-anchor="middle" font-size="18" font-weight="bold">Step-up Transformer Vs>Vp</text></svg>"""
